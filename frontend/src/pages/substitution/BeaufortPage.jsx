// src/pages/substitution/BeaufortPage.jsx
...
const BeaufortPage = () => {
  ...
  const [beaufortSquare, setBeaufortSquare] = useState(null);
...
const { trackOperation, isTracking } = useCipherTracking();
  ...
  try {
    let output;
    if (mode === 'encrypt') {
      output = beaufortEncrypt(inputText, keyword);
    } else {
      output = beaufortDecrypt(inputText, keyword);
    }
    
    setResult(output);
    setVisualization(getBeaufortVisualization(inputText, keyword));
    
    // Generate analysis for ciphertext
    if (output.length >= 20) {
      const analysisData = analyzeBeaufort(output);
    ...
    console.error('Beaufort cipher error:', err);
  }
  ...
  const handleGenerateSquare = () => {
    if (!showSquare) {
      const square = generateBeaufortSquare();
      setBeaufortSquare(square);
    }
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-400">
            Reciprocal cipher using reverse Vigenère technique
          </p>
        </div>
        ...
        <div className="mb-6 p-4 bg-blue-100 dark:bg-blue-900 rounded-lg border border-blue-300 dark:border-blue-700">
          <p className="text-sm text-blue-900 dark:text-blue-100">
            <strong>Note:</strong> The Beaufort cipher is a reciprocal cipher, meaning the same key and process 
            are used for both encryption and decryption. It subtracts the plaintext from the key instead of adding them.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
            ...
            <div className="flex gap-3">
              ...
              disabled={isTracking}  // ← ADD disabled state
              className="flex-1 bg-indigo-600 hover:bg-indigo-700 text-white font-semibold py-3 rounded-lg transition shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed"  // ← ADD disabled styles
            >
          ...
          <div className="mt-6 bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
            ...
            <div className="mb-4 p-3 bg-indigo-50 dark:bg-indigo-900/20 rounded-lg">
              <p className="text-sm text-indigo-900 dark:text-indigo-200">
                ...
                Formula: C = (K - P) mod 26
                        ...
                        {/* Beaufort Square - Perubahan Warna */}
            <div className="overflow-x-auto">
              <div className="inline-block min-w-full">
                <table className="border-collapse">
                  ...
                  <tbody>
                    {beaufortSquare.map((row, rowIndex) => (
                      <tr key={rowIndex}>
            ...
            <div className="mt-4 p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
              <p className="text-xs text-gray-600 dark:text-gray-400">
                ...
                a plaintext letter (P). Unlike Vigenère which adds (P+K), Beaufort subtracts in reverse (K-P).
              </p>
            </div>
          </div>
        )}
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-mono text-green-600 dark:text-green-400">
                      {analysis.isReciprocal ? 'Reciprocal ✓' : 'Standard'}
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div className="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
                ...
                <div className="space-y-1 text-xs text-gray-600 dark:text-gray-400">
                  ...
                  <p className="mt-2 text-indigo-600 dark:text-indigo-400">
                    <strong>Beaufort is reciprocal:</strong> Same process for encrypt/decrypt
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="mt-4 p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400 mt-2">
            ...
            Each letter in the keyword is subtracted from the plaintext letter in reverse: <code className="px-1 bg-white dark:bg-gray-800 rounded">C = (K - P) mod 26</code>
          </p>
        </div>
      </div>
    )}
    ...
    <div className="mt-6 bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div>
          ...
          <ul className="space-y-2 text-gray-600 dark:text-gray-400">
            <li className="flex items-start">
              ...
              <span>Uses reverse subtraction: Key - Plaintext</span>
            </li>
            <li className="flex items-start">
              <span className="text-indigo-600 dark:text-indigo-400 mr-2">•</span>
            ...
            <li className="flex items-start">
              <span className="text-indigo-600 dark:text-indigo-400 mr-2">•</span>
              <span>Reciprocal cipher: same operation for encryption/decryption</span>
            </li>
            <li className="flex items-start">
              <span className="text-indigo-600 dark:text-indigo-400 mr-2">•</span>
              <span>Related to Vigenère but with reverse subtraction</span>
            </li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-gray-600 dark:text-gray-400">
            <li className="flex items-start">
              <span className="font-semibold text-indigo-600 dark:text-indigo-400 mr-2">Reciprocal:</span>
              <span>Same key encrypts and decrypts</span>
            </li>
            <li className="flex items-start">
            ...
            <li className="flex items-start">
              <span className="font-semibold text-indigo-600 dark:text-indigo-400 mr-2">Symmetric:</span>
              <span>No distinction between encryption and decryption</span>
            </li>
            <li className="flex items-start">
              <span className="font-semibold text-indigo-600 dark:text-indigo-400 mr-2">Naval Use:</span>
              <span>Named after Admiral Sir Francis Beaufort</span>
            </li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-gray-600 dark:text-gray-400">
            <li className="flex items-start">
              ...
              <span>Reciprocal property simplifies implementation</span>
            </li>
            <li className="flex items-start">
              <span className="text-green-600 dark:text-green-400 mr-2">✓</span>
            ...
            <li className="flex items-start">
              <span className="text-green-600 dark:text-green-400 mr-2">✓</span>
              <span>Easy to use with same key for both operations</span>
            </li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-gray-600 dark:text-gray-400">
            ...
            <li className="flex items-start">
              <span className="text-red-600 dark:text-red-400 mr-2">✗</span>
              <span>Similar weaknesses to Vigenère cipher</span>
            </li>
            <li className="flex items-start">
              <span className="text-red-600 dark:text-red-400 mr-2">✗</span>
      ...
      <div className="mt-6 p-4 bg-indigo-50 dark:bg-gray-700 rounded-lg border-l-4 border-indigo-600">
        ...
        <div className="space-y-2 font-mono text-sm text-gray-700 dark:text-gray-300">
          <p><strong>Encryption:</strong> Cᵢ = (Kᵢ - Pᵢ) mod 26</p>
          <p><strong>Decryption:</strong> Pᵢ = (Kᵢ - Cᵢ) mod 26</p>
          <p className="text-xs mt-2 font-sans">
            ...
            Note: The operation is the same for both encryption and decryption (reciprocal property).
          </p>
        </div>
      </div>
      ...
      <div className="mt-6 p-4 bg-blue-50 dark:bg-blue-900/30 rounded-lg border-l-4 border-blue-600">
        <p className="text-sm text-gray-700 dark:text-gray-300">
          <strong className="text-indigo-600 dark:text-indigo-400">Historical Note:</strong> The Beaufort cipher is named after Admiral Sir Francis Beaufort, 
          who devised the Beaufort scale for measuring wind force. While he didn't invent this cipher system, 
          it bears his name due to its use in British naval communications. The cipher is a reciprocal cipher, 
          meaning the same operation and key can be used for both encryption and decryption. This property made 
          it particularly useful for naval communications where simplicity was valued. It's a variant of the 
          Vigenère cipher but uses reverse subtraction instead of addition.
        </p>
      </div>
    </div>
  </div>
